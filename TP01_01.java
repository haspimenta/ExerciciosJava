 ...
 * em 2016/09/29
 * -----------------------------------------------------
 * Escreva um programa que recebe um número inteiro positivo e escreve um 
...
public class TP01_01
{
    ...
    //função chama quantidade desejada para criar as linhas com os numeros;
    public static void main(String[] args){
        int nLinhas = nLinhas("Digite a quantidade para contagem e formação do triângulo: ");
        Quantidade(nLinhas); //chama a função onde vamos registrar os dados dos alunos;
    }
    //função chama impressão, entrada e armazenamento do valor desejado para contagem;
    public static int nLinhas(String message){
        System.out.print(message);
        int i = scanner.nextInt();
        return i;
    }
    //função com a regra para calculo do triângulo;
    public static void Quantidade(int nLinhas){
        for(int linhas = nLinhas; linhas >= 0; --linhas) { //contagem de linhas;
            ...
            System.out.println();// imŕessão de quebra;
        }
    }
}
